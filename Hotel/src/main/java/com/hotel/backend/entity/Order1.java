...
@NamedQueries({
    ...
    @NamedQuery(name = "Order1.findByFoodId", query = "SELECT o FROM Order1 o WHERE o.foodId = :foodId"),
...
public class Order1 implements Serializable {
    ...
    public Order1(Integer id, int userId, int foodId, int quantity, int total) {
        this.id = id;
        this.userId = userId;
        this.foodId = foodId;
    ...
    public String toString() {
        return "com.hotel.backend.entity.Order1[ id=" + id + " ]";
    }
